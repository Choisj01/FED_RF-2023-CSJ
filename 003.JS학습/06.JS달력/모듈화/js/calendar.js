...
function MakeDallyeok(selEl){ 
    ...
    const initDallyeok = () => {
        ...
        // 6. 날짜 데이터 태그 구성하기
        // 6-1. 전달 날짜 앞쪽 채우기
        // 조건 : 현재달 첫날짜 요일이 0(일요일)이 아니면 내용있음!
        // 왜 0인가? 0은 일요일 이므로 0이면 앞에 내용 없음!
        ...
        // 9. 날짜정보를 사용하도록 셋팅하기 ////////
        // (1)대상선정 : .dates -> 위에서 새로 담겼으므로 새로 읽음!
    ...
    this.chgCalendar = (num) => {
        ...
        // 이전/다음 달로 변경하여 initDallyeok() 함수호출!
