...
// 달력 컴포넌트 함수 호출하여 달력셋팅하기
// 대상 : .dalcom1 , .dalcom2
new DalCom('.dalcom1');

const dc2 = new DalCom('.dalcom2'); //new써서 생성자함수로 만들어줌!
// 요구사항 : 두번째 달력은 다음달 달력이 처음에 출력되게 함!
// 다음달 달력을 쓸 수 있게 이전/다음달 달력변경 내부함수를
// 생성자함수에 this 키워드로 등록하여 노출해야한다!!
dc2.chgCalendar(1);
...
calBox.mouseenter(function(){
    ...
    $(this).find('.date').click(()=>{
        ...
        // parent() 한단계 위의 부모요소 선택
        // parents(특정요소) 부모들중 특정요소 선택 
