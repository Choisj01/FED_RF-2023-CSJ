...
// JS외부 파일은 html문서에 직접 들어가 작동되므로 
// CSS처럼 "utf-8" 인코딩설정이 필요없음!
...
var cnt_spot = document.querySelector('.stxt span'); /*  할당하는 것도 명령문으로 ; 세미콜론 필수! */
...
function insertMini(){
    ...
    // 읽어올 대상 : .mini-space -> blue-_box 변수
    ...
    // length -> 전제개수읽기
     ...
     // typeof 변수 -> 변수의 데이터형 출력! (콘솔에 확인해보면 형식인 number가 출력됨)
