...
-> window는 주로 생략함!
-> 개발자모드 'Application' 탭에서 확인가능!!

1. 정의 : 
    브라우저별 로컬 어플리케이션 영역에 저장되는 
    스트링데이터(문자데이터) 저장소(JS API)
...
function localSFn() {
    ...
    if (btxt == "처음") {
        ...
        // console.log("로컬쓰lname:",
        //     localStorage.getItem("lname"));
        // 만약 값이 셋팅안됐으면 null값이 나옴!
        ...
        localStorage.clear();
        // 개별 로컬스토리지로 지우는 방법은 removeItem(키명)
    } /////////////else if: 전체삭제 ///////////////
...
function sessionSFn() {
    ...
    if (btxt == "처음") {
        ...
        // 개별 세션스토리지로 지우는 방법은 removeItem(키명)
    } /////////////else if: 전체삭제 ///////////////
    else if (btxt == "보여줘") {
