...
// 컴포넌트 호출하기1 : 개발자찍기
ReactDOM.render(
    <Developer isDev={true} isrc={devImg[0]} ialt="개발자 공유" itit="프론트엔드 개발자 공유입니다!" />,
...
// 4-2. 전체출력 컴포넌트 ///////////////////
// 구성 : 전체타이틀(Title 컴포넌트 사용) + 변경버튼 + 작가와 그림출력(MakeWork컴포넌트)
...
function ExpComp(props){
    ...
    return(
        <React.Fragment>
            ...
            {/* 3. 작품출력 : 삼항연산자로 작품변경하기 
            result변수를 후크변수로 셋팅하면 컴포넌트가 이 변수의 값이 변경됨에 따라
            자동으로 재설정된다! */}
            {
                result ? 
                <MakeWork 
