...
function MarkLike(){
    ...
    /********************************************************** 
        ...
        모든버튼이 새롭게 업데이트되어 화면에 리랜더링됨
        이때 호출되는 함수도 새로 만들어져서 호출됨!
        -> 이게 효율성과 최적화의 문제로 나타남!!!
    ...
    **********************************************************/
    ...
    return(
        <div style={{textAlign:'center'}}>
            ...
            {/* 좋아요 버튼 서브 컴포넌트 호출 */}
            <ShowLike 
            name="손흥민" sts={son} fn={toggleSon} />
            <ShowLike 
            name="다나카" sts={danaka} fn={toggleDanaka} />
            <ShowLike 
            name="이강인" sts={lee} fn={toggleLee} />
