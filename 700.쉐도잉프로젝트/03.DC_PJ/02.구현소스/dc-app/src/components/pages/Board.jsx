...
export function Board() {
    ...
    // 6. 최초 랜더링시 상태관리 변수 : 처음 한번만 내림차순 적용하기
  ...
  ****************************************/
    ...
    // 먼저 적용된다! (글쓰기 후 리스트로 오기/ 검색직후에 적용함!)
    if (firstSts.current) {
        // 내림차순 정렬 적용하기
  ...
  *************************************/
    const pagingLink = () => {
        ...
        // [ 페이징의 페이징하기 ]
        // [1] 페이징 블록 - 한 페이징 블록 수: pPgBlock변수(4)
...
const AttachBox = () => {
    ...
    // 파일정보 업데이트하기 함수 //////
    const changeUpload = ({target}) => { // target은 이벤트 타켓!
        // 파일정보 읽어오기
