...
export const CartList = memo(({ selData, flag }) => {
    ...
    // 외부데이터 업데이트는 flag.current값이 true까지 되어야 한다!
    ...
    const deleteItem = (e) => {
        ...
        let confMsg = "정말정말정말정말로 지우시겠습니까? 할인도 하는데?";
        // 지울지 여부를 사용자에게 물어본다!
    ...
    const goResult = (e) => {
        ...
        // 해당 데이터 업데이트하기
        // forEach로 돌리면 중간에 맞을 경우 리턴할 수 없음!
        ...
        // [ Array.some() 메서드 테스트 ]////////
        // cartData.some((v) => {
        //     console.log('some텍스트상단:',v.idx);
        //     // if(v.idx===17){return true;} -> for문 break과 유사
        //     if(v.idx===17){return false;} // -> for문 continue와 유사
        //     console.log('some텍스트하단:',v.idx);
        // });
        ...
        // 그러나,,, 기존 배열자체가 추가/삭제되지 않는 한
        // 배열데이터가 업데이트 된 것으로 인식되지 않는다!
        // 따라서 강제 리랜더링상태값을 설정하여 이 값을
        // 변경하여 리랜더링 하자!
  ...
  *************************************/
    const bindList = () => {
        ...
        //console.log('찍기직전 Data:',tempData);
